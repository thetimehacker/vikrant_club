...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4094663945ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=database&table=club">`database`.`club`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=database&table=student">`database`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=database&table=signup">`database`.`signup`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=database&table=activity">`database`.`activity`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_data&table=Signup_form_data">`project_data`.`Signup_form_data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_data&table=student_coordinator">`project_data`.`student_coordinator`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=information_schema&table=ALL_PLUGINS">`information_schema`.`ALL_PLUGINS`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpmyadmin&table=pma__central_columns">`phpmyadmin`.`pma__central_columns`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpmyadmin&table=pma__bookmark">`phpmyadmin`.`pma__bookmark`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="726d5276703258546c46594121572d31">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="database" targettable="activity">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `activity`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="database" targettable="signup">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `signup`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="database" targettable="activity">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `signup`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="database" targettable="club">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `club`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="database" targettable="activity">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `signup`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="database" targettable="student">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `student`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="database" targettable="activity">
                            <div class="action_content">
